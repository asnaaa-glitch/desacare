...
let pages = ["home","dashboard","lapor","data","dana","login","help"];
...
<span onclick="gantiStatus(${i})">${l.status}</span>

<img src="${l.foto}" style="width:100%;border-radius:10px;margin-top:10px">
...
<img src="${d.bukti}" style="width:100%;border-radius:10px;margin-top:10px">
...
totalDana.innerText = total.toLocaleString();
}
...
function revealOnScroll(){
    ...
    reveals.forEach(el=>{
        ...
        if(elementTop < windowHeight - 100){let laporan = JSON.parse(localStorage.getItem("laporan")) || [];
let dana = JSON.parse(localStorage.getItem("dana")) || [];
let isLogin = false;
